...
import org.deeplearning4j.nn.conf.layers.{BatchNormalization, ConvolutionLayer, DenseLayer,
...
object LenetMnistExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val seed = randomGen.nextInt   // seed is random
    ...
    val mnistTrain = new MnistDataSetIterator(batchSize, true, randomGen.nextInt)
    val mnistTest = new MnistDataSetIterator(batchSize, false, randomGen.nextInt)
